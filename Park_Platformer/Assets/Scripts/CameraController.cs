...
public class CameraController : MonoBehaviour
{
    ...
    private void CalculateBounds()
    {
        ...
        rightBoundary = tilemap.transform.position.x + tilemap.cellBounds.min.x - viewportHalfSize.x;
    ...
    private void LateUpdate()
    {
        ...
        smoothedPosition.x = Mathf.Clamp(smoothedPosition.x, leftBoundary, smoothedPosition.x);
